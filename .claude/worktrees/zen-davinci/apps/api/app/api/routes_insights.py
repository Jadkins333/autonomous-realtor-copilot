...
from app.services.insights import compute_micro_market_nowcast, compute_parcel_insights, score_marketing_package
...
def marketing_score(
    ...
    return score_marketing_package(db, auth.tenant_id, payload.model_dump())
